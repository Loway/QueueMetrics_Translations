...
## ART?
    ...
    art_deprecated_page=?Aviso: Uma nova página de agente está disponível agora. A que você está usando será removida na próxima versão. Peça ao seu administrador para migrar para a página de agente atualizada.
...
## Headers
    ...
    hdr_dbtest_ephemeral_attribute_inspector=?Ver Atr. efêmeros
    hdr_distrib=Distrib.
    hdr_distrib_day=Dia
    ...
    hdr_transcription_servers=?Servidores de transcrição
...
### Cases
    ...
    edit_record_qa_testaidialog=?Testar diálogo de IA
    ...
    edit_record_qaitems_explanation=?Explicação:
    ...
    edit_transcription_channel_delete_ok=?Canal de transcrição excluído com sucesso
    # 👽 edit_transcription_channel_delete_error -> Error deleting transcription channel
    edit_transcription_channel_delete_error=?Erro ao excluir o canal de transcrição
    # 👽 edit_record_transcription_delete -> Delete
    edit_record_transcription_delete=?Excluir
    ...
    edit_record_transcription_channel_remote_media_file=?Arquivo de mídia remoto
    # 👽 edit_record_transcription_channel_state -> State
    edit_record_transcription_channel_state=?Estado
    # 👽 edit_record_transcription_channel_reserverd_at -> Reserved At
    edit_record_transcription_channel_reserverd_at=?Reservado em
    # 👽 edit_record_transcription_channel_last_seen -> Last Seen
    edit_record_transcription_channel_last_seen=?Visto por último
    # 👽 edit_record_transcription_channel_tokens_in -> Tokens Input
    edit_record_transcription_channel_tokens_in=?Tokens de Entrada
    # 👽 edit_record_transcription_channel_tokens_out -> Tokens Output
    edit_record_transcription_channel_tokens_out=?Tokens de Saída
    ...
    edit_record_transcription_server_main_tag=?Tag principal
    # 👽 edit_record_transcription_server_extra_tags -> Extra Tags
    edit_record_transcription_server_extra_tags=?Tags extras
    ...
    edit_record_transcription_server_channels=?Canais
    # 👽 edit_record_transcription_server_priority -> Priority
    edit_record_transcription_server_priority=?Prioridade
    # 👽 edit_record_transcription_server_tags -> Tags
    edit_record_transcription_server_tags=?Tags
    # 👽 edit_record_transcription_server_title -> Transcription Server Detail
    edit_record_transcription_server_title=?Detalhes do servidor de transcrição
    ...
    edit_record_transcription_server_description=?Descrição
    # 👽 edit_record_transcription_server_driver_parms -> Parameters
    edit_record_transcription_server_driver_parms=?Parâmetros
    # 👽 edit_record_transcription_server_status -> Status
    edit_record_transcription_server_status=?Status
    # 👽 edit_record_transcription_server_healthy -> Healthy
    edit_record_transcription_server_healthy=?Íntegro
    # 👽 edit_record_transcription_server_last_health -> Last Health Check
    edit_record_transcription_server_last_health=?Última verificação de integridade
    ...
    edit_transcription_servers_title=?Editar servidores de transcrição
    # 👽 edit_transcription_go_live_status -> Go to live view
    edit_transcription_go_live_status=?Ir para a visualização ao vivo
    ...
    edit_qa_locked=?Bloqueado
    # 👽 edit_qa_prompt -> Prompt
    edit_qa_prompt=?Prompt
    # 👽 edit_qa_sections -> Sections
    edit_qa_sections=?Seções
    # 👽 edit_qa_visibility -> Queue visibility
    edit_qa_visibility=?Visibilidade da fila
    # 👽 edit_record_qa_ai -> Automated QA
    edit_record_qa_ai=?QA automatizado
    # 👽 edit_record_qa_aiprompt -> AI prompt:
    edit_record_qa_aiprompt=?Prompt de IA:
    # 👽 edit_record_qa_aiqueues -> Queues for automated QA:
    edit_record_qa_aiqueues=?Filas para QA automatizado:
    # 👽 edit_record_qa_aiqueues_hint -> Pipe-separated list of queues this applies to.    
    edit_record_qa_aiqueues_hint=?Lista de filas separadas por barra vertical às quais isso se aplica.
...
## Quality Assessments
    ...
    qa_grading_no_valid_targets=?Por favor, insira ao menos um alvo de classificação
...
### Automated AI grading
    ...
    qa_ai_grading=?Classificação por IA
    # 👽 qa_ai_testdialog_col_comment -> Comment
    qa_ai_testdialog_col_comment=?Comentário
    # 👽 qa_ai_testdialog_col_item -> Item
    qa_ai_testdialog_col_item=?Ítem
    ...
    qa_ai_testdialog_hint=?Esta é a requisição enviada ao motor de LLM, sobre uma transcrição de chamada de exemplo. Edite-a e tente novamente para ver como o modelo reage.
    ...
    qa_ai_testdialog_prompt_hint=?Prompt: esta parte depende apenas do formulário PR, portanto é a mesma para cada chamada e o motor de LLM pode armazená-la em cache.
    # 👽 qa_ai_testdialog_request -> Request
    qa_ai_testdialog_request=?Requisição
    # 👽 qa_ai_testdialog_response -> Response
    qa_ai_testdialog_response=?Resposta
    # 👽 qa_ai_testdialog_title -> Test AI dialog
    qa_ai_testdialog_title=?Testar diálogo de IA
    # 👽 qa_ai_testdialog_transcript_hint -> Transcript: this part changes with every call, so it is sent separately and never cached.
    qa_ai_testdialog_transcript_hint=?Transcrição: esta parte muda a cada chamada, portanto é enviada separadamente e nunca é armazenada em cache.
    # 👽 qa_ai_testdialog_try -> Try it
    qa_ai_testdialog_try=?Tentar
    # 👽 qa_grader_col_agent -> Agent
    qa_grader_col_agent=?Agente
    # 👽 qa_grader_col_call_duration -> Call duration
    qa_grader_col_call_duration=?Duração da chamada
    # 👽 qa_grader_col_caller -> Caller
    qa_grader_col_caller=?Originador
    # 👽 qa_grader_col_datetime -> Date/time
    qa_grader_col_datetime=?Data/hora
    # 👽 qa_grader_col_queue -> Queue
    qa_grader_col_queue=?Fila
    # 👽 qa_grader_col_score -> Score
    qa_grader_col_score=?Pontuação
    # 👽 qa_grader_col_tokens -> Tokens
    qa_grader_col_tokens=?Tokens
    # 👽 qa_grader_col_transcription_duration -> Scoring time
    qa_grader_col_transcription_duration=?Tempo de pontuação
    # 👽 qa_grader_no_more_calls -> No other calls found
    qa_grader_no_more_calls=?Nenhuma outra chamada encontrada
    # 👽 qa_grader_notrack_err -> You need key QA_TRACK to access this page
    qa_grader_notrack_err=?Você precisa da chave QA_TRACK para acessar esta página
    # 👽 qa_grader_stat_attempted -> Attempted
    qa_grader_stat_attempted=?Tentativas
    # 👽 qa_grader_stat_average_score -> Average score
    qa_grader_stat_average_score=?Pontuação média
    # 👽 qa_grader_stat_calls_loaded -> Calls loaded
    qa_grader_stat_calls_loaded=?Chamadas carregadas
    # 👽 qa_grader_stat_evaluated -> Evaluated
    qa_grader_stat_evaluated=?Avaliadas
    # 👽 qa_grader_stat_evaluation_errors -> Evaluation errors
    qa_grader_stat_evaluation_errors=?Erros de avaliação
    # 👽 qa_grader_stat_maximum_score -> Max. score
    qa_grader_stat_maximum_score=?Pontuação máx.
    # 👽 qa_grader_stat_minimum_score -> Min. score
    qa_grader_stat_minimum_score=?Pontuação mín.
    # 👽 qa_grader_stat_tokens_used -> Tokens used
    qa_grader_stat_tokens_used=?Tokens utilizados
...
## Wallboard
    ...
    rt3_goto_view=?Ir para a visualização
    rt3_green=Verde
    rt3_hangup=Desligar
    rt3_hold=Reter
    ...
    rt3_manual_insert=?Inserir Manualmente
...
Description of configuration properties
    ...
    propedit_key_agent_leaveAllQueuesOnLogoff_desc=?Agentes serão automaticamente deslogados de todas as filas no logout
    ...
    propedit_key_maxGatheringTime=?Define o tempo total máximo permitido para o processo de coleta ICE. Se definido como 0, a otimização é desativada.
    ...
    propedit_key_maxPostGatheringTime=?A duração do tempo limite flexível acionado após a detecção de um candidato STUN/TURN roteável.
    ...
    propedit_category_ai_integration=?Integração de IA
    # 👽 propedit_feature_ai_integration_settings -> General Settings
    propedit_feature_ai_integration_settings=?Configurações Gerais
    ...
    propedit_key_llm_captureUniqueId_desc=?Esta expressão regular é usada para capturar o UniqueId da chamada a partir do nome do arquivo. Ex.: audio-(.+).wav capturará o uniqueid 1234.1235 do arquivo audio-1234.1235.wav. Se deixado em branco, nenhum UniqueId será capturado
    # 👽 propedit_key_llm_verbose_desc -> Print input and output from/to the LLM model to the system log
    propedit_key_llm_verbose_desc=?Imprime a entrada e saída de/para o modelo LLM no log do sistema
    # 👽 propedit_key_qa_minPrcAllCalls_desc -> Default value of mininum percentage of calls scored for All calls on Grader's page
    propedit_key_qa_minPrcAllCalls_desc=?Valor padrão da porcentagem mínima de chamadas pontuadas para Todas as chamadas na página do Grader
...
Description of security keys:
    ...
    keydesc_hid=?Habilitar controles de headset do Softphone
    ...
    keydesc_nodialout=?Usuário não tem permissão para fazer chamadas externas
    ...
    keydesc_qa_chat_read=?Permite aos usuários ler o chat e a transcrição da interação
    # 👽 keydesc_qa_chat_edit -> Allows users to edit the interaction's chat and transcription
    keydesc_qa_chat_edit=?Permite aos usuários editar o chat e a transcrição da interação
    # 👽 keydesc_qa_chat_delete -> Allows users to delete the interaction's chat and transcription
    keydesc_qa_chat_delete=?Permite aos usuários excluir o chat e a transcrição da interação
    # 👽 keydesc_qa_chat_write -> Allows users to load the interaction's chat or transcription
    keydesc_qa_chat_write=?Permite aos usuários carregar o chat ou a transcrição da interação
    ...
    keydesc_queue_login_assigned_only=?Os usuários só podem fazer login nas filas atribuídas a eles
    ...
    keydesc_transcription_server=?Usuário pode ver e atualizar os servidores de transcrição
    ...
    keydesc_ephemeral_read=?Os usuários podem ler da tabela de dados efêmeros
    # 👽 keydesc_ephemeral_write -> Users can write to the ephemeral data table
    keydesc_ephemeral_write=?Os usuários podem gravar na tabela de dados efêmeros
...
### Softphone
    ...
    phone_mute_toggle=?Alternar Mudo
    ...
    phone_audio_mic_not_found=?Nenhum dispositivo de microfone encontrado
    # 👽 phone_audio_settings -> Audio Settings
    phone_audio_settings=?Configurações de Áudio
    # 👽 phone_audio_device_not_found -> Audio device not found
    phone_audio_device_not_found=?Dispositivo de áudio não encontrado
    # 👽 phone_choose_device -> Choose device..
    phone_choose_device=?Escolha o dispositivo..
    # 👽 phone_default_audio_device -> Using default audio device
    phone_default_audio_device=?Usando o dispositivo de áudio padrão
    ...
    phone_hid_close_device=?Dispositivo HID fechado
    # 👽 phone_hid_close_device_err -> Error occurred while closing HID device
    phone_hid_close_device_err=?Ocorreu um erro ao fechar o dispositivo HID
    # 👽 phone_hid_device_already_open -> HID device already open
    phone_hid_device_already_open=?Dispositivo HID já está aberto
    ...
    phone_hid_open_device=?Selecione um dispositivo HID
    # 👽 phone_hid_open_device_err -> Error occurred while opening HID device
    phone_hid_open_device_err=?Ocorreu um erro ao abrir o dispositivo HID
    # 👽 phone_selected_audio_device -> Selected audio device
    phone_selected_audio_device=?Dispositivo de áudio selecionado
    # 👽 phone_selected_hid_device -> Selected HID device
    phone_selected_hid_device=?Dispositivo HID selecionado
    # 👽 phone_selected_mic_device -> Selected microphone device
    phone_selected_mic_device=?Dispositivo de microfone selecionado
    # 👽 phone_selected_ringtone_device -> Selected ringtone device
    phone_selected_ringtone_device=?Dispositivo de toque selecionado
    # 👽 phone_set_audio_info -> Changed audio device
    phone_set_audio_info=?Dispositivo de áudio alterado
    # 👽 phone_set_mic_info -> Changed mic device
    phone_set_mic_info=?Dispositivo de microfone alterado
    # 👽 phone_set_audio_err -> Error occurred while setting audio device
    phone_set_audio_err=?Ocorreu um erro ao definir o dispositivo de áudio
    # 👽 phone_ringtone -> Ringtone    
    phone_ringtone=?Toque
...
## Homepage
    ...
    home_configuration_transcription_servers=?Servidores de transcrição
    ...
    home_dbtest_ephemeral_attribute_inspector=?Inspetor de Atr. efêmeros
    ...
    home_master_key_error=?Masterkey habilitada — uso recomendado apenas para testes
    ...
    home_transcription_title=?Transcrições ao vivo
    # 👽 home_transcription_subtitle -> View of Live Transcriptions
    home_transcription_subtitle=?Visualização de transcrições ao vivo
...
These are the titles of data blocks:
    ...
    teams_blk_external_callers=?Chamadores Externos
    # 👽 teams_blk_external_callees -> External Callees
    teams_blk_external_callees=?Chamados Externos
    # 👽 teams_blk_external_callers_on_all -> External Callers (on all Calls)
    teams_blk_external_callers_on_all=?Chamadores Externos (em todas as Chamadas)
    # 👽 teams_blk_external_callees_on_all -> External Callees (on all Calls)
    teams_blk_external_callees_on_all=?Chamados Externos (em todas as Chamadas)
    # 👽 teams_blk_caller_classification -> Teams Caller Classification
    teams_blk_caller_classification=?Classificação do Chamador Teams
    # 👽 teams_blk_callee_classification -> Teams Callee Classification
    teams_blk_callee_classification=?Classificação do Chamado Teams
...
These are kinds of calls:
    ...
    teams_kind_guest_user=?Usuário Convidado
    # 👽 teams_kind_ext_user -> External User
    teams_kind_ext_user=?Usuário Externo
    # 👽 teams_kind_phone -> Phone
    teams_kind_phone=?Telefone
    # 👽 teams_kind_other -> Other
    teams_kind_other=?Outro

These are localization labels for data blocks:

    # 👽 teams_caller_domain -> Caller domain
    teams_caller_domain=?Domínio do Chamador
    # 👽 teams_n_calls -> N. Calls
    teams_n_calls=?N. Chamadas
    # 👽 teams_avg_wait -> Avg Wait
    teams_avg_wait=?Esp. Média
    # 👽 teams_avg_talk -> Avg Talk
    teams_avg_talk=?Tempo Médio
    # 👽 teams_tot_talk -> Tot Talk
    teams_tot_talk=?Tempo Total
    # 👽 teams_all_calls -> All Calls
    teams_all_calls=?Todas as Chamadas
    # 👽 teams_guest_n_calls -> Guest N Calls
    teams_guest_n_calls=?N Chamadas Convidado
    # 👽 teams_guest_avg_wait -> Guest Avg Wait
    teams_guest_avg_wait=?Esp. Média Convidado
    # 👽 teams_guest_avg_talk -> Guest Avg Talk
    teams_guest_avg_talk=?Tempo Médio Convidado
    # 👽 teams_guest_tot_talk -> Guest Tot Talk
    teams_guest_tot_talk=?Tempo Total Convidado
    # 👽 teams_ext_n_calls -> Ext N Calls
    teams_ext_n_calls=?N Chamadas Ext
    # 👽 teams_ext_avg_wait -> Ext Avg Wait
    teams_ext_avg_wait=?Esp. Média Ext
    # 👽 teams_ext_avg_talk -> Ext Avg Talk
    teams_ext_avg_talk=?Tempo Médio Ext
    # 👽 teams_ext_tot_talk -> Ext Tot Talk
    teams_ext_tot_talk=?Tempo Total Ext
...
Other items
    ...
    err_not_blank=?Entrada não pode ficar em branco.
    ...
    graph_position=?Posição do Gráfico
    ...
    graph_position_left=?Esquerda
    # 👽 graph_position_right -> Right
    graph_position_right=?Direita
    # 👽 graph_size -> Graph Size
    graph_size=?Tamanho do Gráfico
    # 👽 graph_size_big -> Big
    graph_size_big=?Grande
    # 👽 graph_size_normal -> Normal
    graph_size_normal=?Normal
    # 👽 graph_size_small -> Small
    graph_size_small=?Pequeno
    # 👽 graph_size_extra_small -> Extra Small
    graph_size_extra_small=?Extra Pequeno
    grp_ivr=Eventos URA
    ...
    licence_licence_expiring=?Sua licença está prestes a expirar
    ...
    licence_software_new_release_available=?Nova versão disponível:
    ...
    qap_agent_license_error=?Excede o limite de agentes licenciados. Por favor, consulte seu supervisor.
    qap_amo=AMO
    ...
    qap_apply_feature_error=?Erro ao aplicar recurso à interação
    # 👽 qap_apply_outcome_error -> Error while applying outcome to interaction
    qap_apply_outcome_error=?Erro ao aplicar resultado à interação
    ...
    qap_label_freetext_error=?Limite de caracteres excedido (máximo 200)
    qap_leave=Abandonar
    qap_loading=Carregando...
    # 👽 qap_logout_message -> Logging you out from all queues
    qap_logout_message=?Deslogando você de todas as filas
    qap_memos=Memos
    ...
    qap_agent_not_present_on_queue=?Agente não está presente na fila de saída selecionada.
    qap_none=Nenhum
    ...
    qap_extended_status=?Status estendido
    # 👽 qap_number_dialed -> Number dialed
    qap_number_dialed=?Número discado
    # 👽 qap_wbt_attempt -> Attempt
    qap_wbt_attempt=?Tentativa
    # 👽 qap_wbt_recall_attempt -> Recall attempts
    qap_wbt_recall_attempt=?Tentativas de rechamada
    # 👽 qap_wombat_call_history -> Call history
    qap_wombat_call_history=?Histórico de chamadas
    # 👽 qap_wombat_dial -> Dial
    qap_wombat_dial=?Discar
    # 👽 qap_wombat_ext_status_success -> Extended status added successful
    qap_wombat_ext_status_success=?Status estendido adicionado com sucesso
    # 👽 qap_wombat_number_dial -> Number to dial
    qap_wombat_number_dial=?Número a discar
    # 👽 qap_wombat_out_attribute_success -> Attribute added successful
    qap_wombat_out_attribute_success=?Atributo adicionado com sucesso
    # 👽 qap_wombat_reserve -> Reserve
    qap_wombat_reserve=?Reservar
    # 👽 qap_wombat_rs_agent -> Retry Requested
    qap_wombat_rs_agent=?Nova tentativa solicitada
    # 👽 qap_wombat_rs_agentskip -> Agent Skip
    qap_wombat_rs_agentskip=?Agente ignorado
    # 👽 qap_wombat_rs_blacklist -> Number Blacklisted
    qap_wombat_rs_blacklist=?Número na lista negra
    # 👽 qap_wombat_rs_busy -> Line Busy
    qap_wombat_rs_busy=?Linha ocupada
    # 👽 qap_wombat_rs_err -> Technical Error
    qap_wombat_rs_err=?Erro técnico
    # 👽 qap_wombat_rs_lost -> Call Lost
    qap_wombat_rs_lost=?Chamada perdida
    # 👽 qap_wombat_rs_noagent -> Agent Timeout
    qap_wombat_rs_noagent=?Tempo limite do agente
    # 👽 qap_wombat_rs_noanswer -> No Answer
    qap_wombat_rs_noanswer=?Sem resposta
    # 👽 qap_wombat_rs_number -> Invalid Number
    qap_wombat_rs_number=?Número inválido
    # 👽 qap_wombat_rs_rejected -> Network Reject
    qap_wombat_rs_rejected=?Rejeição da rede
    # 👽 qap_wombat_rs_terminated -> Call Completed
    qap_wombat_rs_terminated=?Chamada concluída
    # 👽 qap_wombat_rs_timeout -> Max Duration
    qap_wombat_rs_timeout=?Duração máxima
    # 👽 qap_wombat_skip -> Skip
    qap_wombat_skip=?Ignorar
    # 👽 qap_wombat_update -> Update
    qap_wombat_update=?Atualizar
    # 👽 qap_wombat_update_disable_msg -> An extended status must be selected
    qap_wombat_update_disable_msg=?Um status estendido deve ser selecionado
    # 👽 qap_generic_error -> Error occured in WombatDialer
    qap_generic_error=?Ocorreu um erro no WombatDialer
    # 👽 qap_agent_not_available -> Agent not available
    qap_agent_not_available=?Agente não disponível
    # 👽 qap_dial_success -> Dialed
    qap_dial_success=?Discado
    # 👽 qap_skip_success -> Skipped
    qap_skip_success=?Ignorado
    # 👽 qap_no_call_to_reserve -> No call available for reservation
    qap_no_call_to_reserve=?Nenhuma chamada disponível para reserva
    # 👽 qap_agent -> Agent
    qap_agent=?Agente
    # 👽 qap_id_not_found -> No such ID
    qap_id_not_found=?ID inexistente
    # 👽 qap_id_found_wrong_state -> The ID exists but the call is in a wrong state
    qap_id_found_wrong_state=?O ID existe, mas a chamada está em um estado incorreto
    # 👽 ephatt_attribute_character_error -> Attribute name cannot contain the '.' character
    ephatt_attribute_character_error=?O nome do atributo não pode conter o caractere '.'
    # 👽 rt3_att_text -> Ephemeral - Text
    rt3_att_text=?Efêmero - Texto
    # 👽 rt3_nofstate_unix_wbt -> Ephemeral - Time
    rt3_nofstate_unix_wbt=?Efêmero - Hora
    # 👽 rt3_circle_wbt_reservable -> Reservable calls
    rt3_circle_wbt_reservable=?Chamadas reserváveis
    # 👽 rt3_circle_wbt_incomplete -> Incomplete calls
    rt3_circle_wbt_incomplete=?Chamadas incompletas
    # 👽 rt3_nofstate_wbt -> Ephemeral - Value
    rt3_nofstate_wbt=?Efêmero - Valor
    # 👽 rt3_wbt_campaign_stats -> Campaign stats
    rt3_wbt_campaign_stats=?Estatísticas da campanha
    # 👽 rt3_wbt_camp_est -> Attempts remaining
    rt3_wbt_camp_est=?Tentativas restantes
    # 👽 rt3_attributes -> Ephemeral Attribute
    rt3_attributes=?Atributo efêmero
    # 👽 rt3_display_value -> Visualization mode
    rt3_display_value=?Modo de visualização
    # 👽 rt3_maxvalue -> Max value
    rt3_maxvalue=?Valor máx.
    # 👽 rt3_md_checkbox -> Is markdown
    rt3_md_checkbox=?É markdown
    # 👽 rt3_normal_number -> Normal
    rt3_normal_number=?Normal
    # 👽 rt3_normal_perc -> Percentage
    rt3_normal_perc=?Porcentagem
    ...
    reports_filter_empty_hour_toggle=?Ocultar slots de hora vazios
    ...
    reports_datablock_info_error=?Não foi possível carregar as informações do DataBlock
    ...
    reports_email_not_valid=?Insira endereços de e-mail válidos
    ...
    reports_exportjob_create=?Criar Nova Tarefa de Exportação
    # 👽 reports_exportjob_create_successful -> Export job created successfully
    reports_exportjob_create_successful=?Tarefa de exportação criada com sucesso
    # 👽 reports_exportjob_error_create -> Error Creating Export Job:
    reports_exportjob_error_create=?Erro ao Criar Tarefa de Exportação:
    # 👽 reports_exportjob_title -> Existing jobs for this report
    reports_exportjob_title=?Tarefas existentes para este relatório
    ...
    reports_filter_pausedurmax=?Duração Máx. de Pausa
    # 👽 reports_filter_pausedurmin -> Min. Pause Duration
    reports_filter_pausedurmin=?Duração Mín. de Pausa
    ...
    reports_filter_sessiondurmax=?Duração Máx. da Sessão
    # 👽 reports_filter_sessiondurmin -> Min. Session Duration
    reports_filter_sessiondurmin=?Duração Mín. da Sessão
    # 👽 reports_filter_sessionext -> Session Ext.
    reports_filter_sessionext=?Ext. da Sessão
    ...
    reports_qa_grader_type=?Tipo de Grader
    ...
    reports_qa_tracked_by=?Avaliado por
    ...
    reports_save_report_title_exception=?Já existe um relatório com o mesmo nome. Selecione um nome diferente.
    reports_save_successful=Relatório salvo com sucesso
    # 👽 reports_scheduled_job -> Scheduled
    reports_scheduled_job=?Agendado
    ...
    reports_qa_noteform_save=?Salvar nota
    # 👽 reports_qa_nonscoring -> Non-Scoring Evaluation
    reports_qa_nonscoring=?Avaliação sem pontuação
    # 👽 report_tab_page_list -> Page List
    report_tab_page_list=?Lista de páginas
    # 👽 reports_delete_filter_text -> Delete Filter
    reports_delete_filter_text=?Excluir filtro
    # 👽 reports_edit_filter_text -> Edit Filter
    reports_edit_filter_text=?Editar filtro
    ...
    sync2_delete_cluster=?Excluir cluster
    ...
    timeline_chat_delete_confirm=?O chat selecionado será excluído. Continuar?
    # 👽 timeline_chat_edit_speakers -> Edit Speakers
    timeline_chat_edit_speakers=?Editar Interlocutores
    # 👽 timeline_chat_segments_history -> View Edit History
    timeline_chat_segments_history=?Ver Histórico de Edições
    # 👽 timeline_chat_segments_delete -> Delete Chat
    timeline_chat_segments_delete=?Excluir Chat
    # 👽 timeline_chat_speaker -> Speaker
    timeline_chat_speaker=?Interlocutor
    # 👽 timeline_chat_edited -> Edited
    timeline_chat_edited=?Editado
    ...
    timeline_download_chat_file=?Baixar arquivo
    ...
    timeline_no_chats=?Nenhum chat disponível
    ...
    timeline_tab_chats_speaker_error=?Os nomes dos interlocutores devem ser únicos
    # 👽 timeline_tab_chats_no -> No
    timeline_tab_chats_no=?Não
    # 👽 timeline_tab_chats_yes -> Yes
    timeline_tab_chats_yes=?Sim
    ...
    title_do_calldistrdo=?Distribuição de Chamadas
    # 👽 title_do_calltagdo -> Call Tags
    title_do_calltagdo=?Tags de Chamadas
    # 👽 title_do_casedo -> Cases
    title_do_casedo=?Casos
    # 👽 title_do_customblkdo -> Custom DataBlock
    title_do_customblkdo=?DataBlock Customizado
    # 👽 title_do_detailsdo -> Details
    title_do_detailsdo=?Detalhes
    # 👽 title_do_distrdo -> Attempts
    title_do_distrdo=?Tentativas
    # 👽 title_do_extsourcedo -> External Source
    title_do_extsourcedo=?Fonte Externa
    # 👽 title_do_fcrdo -> First Call Resolution
    title_do_fcrdo=?Resolução na Primeira Chamada
    # 👽 title_do_groupingsdo -> Calls Grouping
    title_do_groupingsdo=?Agrupamento de Chamadas
    # 👽 title_do_ivrdo -> Ivr Calls
    title_do_ivrdo=?Chamadas de IVR
    # 👽 title_do_kodo -> Unanswered Calls
    title_do_kodo=?Chamadas Não Atendidas
    # 👽 title_do_okdo -> Taken Calls
    title_do_okdo=?Chamadas Atendidas
    # 👽 title_do_outcomesdo -> Call with Outcomes
    title_do_outcomesdo=?Chamadas com Resultados
