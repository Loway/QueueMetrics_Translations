...
## Headers
    ...
    hdr_dbtest_ephemeral_attribute_inspector=?Ver Attr. efímeros
    hdr_distrib=Distrib.
    # 👽 hdr_distrib_day -> Day
    hdr_distrib_day=?Dia
    ...
    hdr_transcription_servers=?Servidores de transcripción
...
### Cases
    ...
    edit_record_qa_testaidialog=?Probar diálogo de IA
    ...
    edit_record_qaitems_explanation=?Explicación:
    ...
    edit_transcription_channel_delete_ok=?Canal de transcripción eliminado correctamente
    # 👽 edit_transcription_channel_delete_error -> Error deleting transcription channel
    edit_transcription_channel_delete_error=?Error al eliminar el canal de transcripción
    ...
    edit_record_transcription_channel_confirm_delete=?Se eliminará el canal de transcripción seleccionado. ¿Continuar?
    # 👽 edit_record_transcription_channel_remote_job_id -> Remote Job ID
    edit_record_transcription_channel_remote_job_id=?ID de trabajo remoto
    # 👽 edit_record_transcription_channel_remote_media_file -> Remote Media File
    edit_record_transcription_channel_remote_media_file=?Archivo multimedia remoto
    ...
    edit_record_transcription_channel_reserverd_at=?Reservado el
    # 👽 edit_record_transcription_channel_last_seen -> Last Seen
    edit_record_transcription_channel_last_seen=?Visto por última vez
    ...
    edit_record_transcription_channel_tokens_out=?Tokens de Salida
    # 👽 edit_record_transcription_channel_tokens -> Tokens
    edit_record_transcription_channel_tokens=?Tokens
    # 👽 edit_record_transcription_server_name -> Name
    edit_record_transcription_server_name=?Nombre
    ...
    edit_record_transcription_server_extra_tags=?Etiquetas adicionales
    # 👽 edit_record_transcription_server_max_channels -> Max Channels
    edit_record_transcription_server_max_channels=?Canales máx.
    # 👽 edit_record_transcription_server_channels -> Channels
    edit_record_transcription_server_channels=?Canales
    # 👽 edit_record_transcription_server_priority -> Priority
    edit_record_transcription_server_priority=?Prioridad
    ...
    edit_record_transcription_server_title=?Detalle del servidor de transcripción
    # 👽 edit_record_transcription_server_transcription -> Transcription
    edit_record_transcription_server_transcription=?Transcripción
    # 👽 edit_record_transcription_server_diarization -> Diarization
    edit_record_transcription_server_diarization=?Diarización
    # 👽 edit_record_transcription_server_quality_grading -> Quality Grading
    edit_record_transcription_server_quality_grading=?Evaluación de calidad
    ...
    edit_record_transcription_server_description=?Descripción
    # 👽 edit_record_transcription_server_driver_parms -> Parameters
    edit_record_transcription_server_driver_parms=?Parámetros
    ...
    edit_record_transcription_server_last_health=?Última comprobación de estado
    ...
    edit_transcription_servers_title=?Editar servidores de transcripción
    # 👽 edit_transcription_go_live_status -> Go to live view
    edit_transcription_go_live_status=?Ir a la vista en vivo
...
## Quality Assessments
    ...
    qa_grading_no_valid_targets=?Por favor, introduzca al menos un objetivo de clasificación
...
### Automated AI grading
    ...
    qa_ai_grading=?Clasificación con IA
    # 👽 qa_ai_testdialog_col_comment -> Comment
    qa_ai_testdialog_col_comment=?Comentario
    # 👽 qa_ai_testdialog_col_item -> Item
    qa_ai_testdialog_col_item=?Elemento
    ...
    qa_ai_testdialog_hint=?Esta es la solicitud enviada al motor LLM, sobre una transcripción de llamada de ejemplo. Edítela y vuelva a intentarlo para ver cómo reacciona el modelo.
    ...
    qa_ai_testdialog_prompt_hint=?Prompt: esta parte solo depende del módulo QA, por lo que es la misma para cada llamada y el motor LLM puede almacenarla en caché.
    # 👽 qa_ai_testdialog_request -> Request
    qa_ai_testdialog_request=?Solicitud
    # 👽 qa_ai_testdialog_response -> Response
    qa_ai_testdialog_response=?Respuesta
    # 👽 qa_ai_testdialog_title -> Test AI dialog
    qa_ai_testdialog_title=?Probar diálogo de IA
    # 👽 qa_ai_testdialog_transcript_hint -> Transcript: this part changes with every call, so it is sent separately and never cached.
    qa_ai_testdialog_transcript_hint=?Transcripción: esta parte cambia con cada llamada, por lo que se envía por separado y nunca se almacena en caché.
    # 👽 qa_ai_testdialog_try -> Try it
    qa_ai_testdialog_try=?Probarlo
    # 👽 qa_grader_col_agent -> Agent
    qa_grader_col_agent=?Agente
    # 👽 qa_grader_col_call_duration -> Call duration
    qa_grader_col_call_duration=?Duración de la llamada
    # 👽 qa_grader_col_caller -> Caller
    qa_grader_col_caller=?Llamante
    # 👽 qa_grader_col_datetime -> Date/time
    qa_grader_col_datetime=?Fecha/hora
    # 👽 qa_grader_col_queue -> Queue
    qa_grader_col_queue=?Cola
    # 👽 qa_grader_col_score -> Score
    qa_grader_col_score=?Puntuación
    # 👽 qa_grader_col_tokens -> Tokens
    qa_grader_col_tokens=?Tokens
    # 👽 qa_grader_col_transcription_duration -> Scoring time
    qa_grader_col_transcription_duration=?Tiempo de evaluación
    # 👽 qa_grader_no_more_calls -> No other calls found
    qa_grader_no_more_calls=?No se han encontrado más llamadas
    # 👽 qa_grader_notrack_err -> You need key QA_TRACK to access this page
    qa_grader_notrack_err=?Necesita la clave QA_TRACK para acceder a esta página
    # 👽 qa_grader_stat_attempted -> Attempted
    qa_grader_stat_attempted=?Intentadas
    # 👽 qa_grader_stat_average_score -> Average score
    qa_grader_stat_average_score=?Puntuación media
    # 👽 qa_grader_stat_calls_loaded -> Calls loaded
    qa_grader_stat_calls_loaded=?Llamadas cargadas
    # 👽 qa_grader_stat_evaluated -> Evaluated
    qa_grader_stat_evaluated=?Evaluadas
    # 👽 qa_grader_stat_evaluation_errors -> Evaluation errors
    qa_grader_stat_evaluation_errors=?Errores de evaluación
    # 👽 qa_grader_stat_maximum_score -> Max. score
    qa_grader_stat_maximum_score=?Puntuación máx.
    # 👽 qa_grader_stat_minimum_score -> Min. score
    qa_grader_stat_minimum_score=?Puntuación mín.
...
## Wallboard
    ...
    rt3_manual_insert=?Inserción manual
...
Description of configuration properties
    ...
    propedit_key_maxGatheringTime=?Establece el tiempo total máximo permitido para el proceso de recopilación ICE. Si se establece en 0, la optimización se desactiva.
    ...
    propedit_key_maxPostGatheringTime=?La duración del tiempo de espera suave que se activa tras detectar un candidato STUN/TURN enrutable.
    ...
    propedit_category_ai_integration=?Integración de IA
    # 👽 propedit_feature_ai_integration_settings -> General Settings
    propedit_feature_ai_integration_settings=?Configuración General
    ...
    propedit_key_llm_captureUniqueId_desc=?Esta expresión regular se utiliza para capturar el UniqueId de la llamada a partir del nombre del archivo. Por ejemplo, audio-(.+).wav capturará el uniqueid 1234.1235 del nombre de archivo audio-1234.1235.wav. Si se deja en blanco, no se captura ningún UniqueId
    # 👽 propedit_key_llm_verbose_desc -> Print input and output from/to the LLM model to the system log
    propedit_key_llm_verbose_desc=?Imprime la entrada y salida hacia/desde el modelo LLM en el registro del sistema
    # 👽 propedit_key_qa_minPrcAllCalls_desc -> Default value of mininum percentage of calls scored for All calls on Grader's page
    propedit_key_qa_minPrcAllCalls_desc=?Valor predeterminado del porcentaje mínimo de llamadas evaluadas para «Todas las llamadas» en la página del Grader
...
Description of security keys:
    ...
    keydesc_hid=?Activar controles de auriculares del softphone
    ...
    keydesc_qa_chat_read=?Permite a los usuarios leer el chat y la transcripción de la interacción
    # 👽 keydesc_qa_chat_edit -> Allows users to edit the interaction's chat and transcription
    keydesc_qa_chat_edit=?Permite a los usuarios editar el chat y la transcripción de la interacción
    # 👽 keydesc_qa_chat_delete -> Allows users to delete the interaction's chat and transcription
    keydesc_qa_chat_delete=?Permite a los usuarios eliminar el chat y la transcripción de la interacción
    # 👽 keydesc_qa_chat_write -> Allows users to load the interaction's chat or transcription
    keydesc_qa_chat_write=?Permite a los usuarios cargar el chat o la transcripción de la interacción
    ...
    keydesc_queue_login_assigned_only=?Los usuarios solo pueden iniciar sesión en sus colas asignadas
    ...
    keydesc_transcription_server=?El usuario puede ver y actualizar los servidores de transcripción
    ...
    keydesc_ephemeral_read=?Los usuarios pueden leer de la tabla de datos efímeros
    # 👽 keydesc_ephemeral_write -> Users can write to the ephemeral data table
    keydesc_ephemeral_write=?Los usuarios pueden escribir en la tabla de datos efímeros
...
### Softphone
    ...
    phone_audio_settings=?Configuración de audio
    # 👽 phone_audio_device_not_found -> Audio device not found
    phone_audio_device_not_found=?Dispositivo de audio no encontrado
    ...
    phone_hid_device_already_open=?Dispositivo HID ya abierto
...
## Homepage
    ...
    home_configuration_transcription_servers=?Servidores de transcripción
    ...
    home_dbtest_ephemeral_attribute_inspector=?Inspector de Attr. efímeros
    ...
    home_transcription_title=?Transcripciones en vivo
    # 👽 home_transcription_subtitle -> View of Live Transcriptions
    home_transcription_subtitle=?Vista de transcripciones en vivo
...
These are localization labels for data blocks:
    ...
    teams_caller_domain=?Dominio de la persona que llama
    ...
    teams_tot_talk=?Tot. Conversación
    ...
    teams_guest_tot_talk=?Invitado Tot. Conversación
    ...
    teams_ext_tot_talk=?Ext Tot. Conversación
...
Other items
    ...
    licence_licence_expiring=?Su licencia está a punto de caducar
    ...
    licence_software_new_release_available=?Nueva versión disponible:
    ...
    qap_agent_license_error=?Se ha superado el límite de agentes de la licencia. Consulte con su supervisor.
    # 👽 qap_amo -> AMO
    qap_amo=?AMO
    ...
    qap_wombat_out_attribute_success=?Atributo añadido correctamente
    # 👽 qap_wombat_reserve -> Reserve
    qap_wombat_reserve=?Reservar
    # 👽 qap_wombat_rs_agent -> Retry Requested
    qap_wombat_rs_agent=?Reintento solicitado
    # 👽 qap_wombat_rs_agentskip -> Agent Skip
    qap_wombat_rs_agentskip=?Agente omitido
    # 👽 qap_wombat_rs_blacklist -> Number Blacklisted
    qap_wombat_rs_blacklist=?Número en lista negra
    # 👽 qap_wombat_rs_busy -> Line Busy
    qap_wombat_rs_busy=?Línea ocupada
    # 👽 qap_wombat_rs_err -> Technical Error
    qap_wombat_rs_err=?Error técnico
    # 👽 qap_wombat_rs_lost -> Call Lost
    qap_wombat_rs_lost=?Llamada perdida
    # 👽 qap_wombat_rs_noagent -> Agent Timeout
    qap_wombat_rs_noagent=?Tiempo de espera de agente agotado
    # 👽 qap_wombat_rs_noanswer -> No Answer
    qap_wombat_rs_noanswer=?Sin respuesta
    # 👽 qap_wombat_rs_number -> Invalid Number
    qap_wombat_rs_number=?Número no válido
    # 👽 qap_wombat_rs_rejected -> Network Reject
    qap_wombat_rs_rejected=?Rechazo de red
    # 👽 qap_wombat_rs_terminated -> Call Completed
    qap_wombat_rs_terminated=?Llamada completada
    # 👽 qap_wombat_rs_timeout -> Max Duration
    qap_wombat_rs_timeout=?Duración máxima
    # 👽 qap_wombat_skip -> Skip
    qap_wombat_skip=?Omitir
    # 👽 qap_wombat_update -> Update
    qap_wombat_update=?Actualizar
    # 👽 qap_wombat_update_disable_msg -> An extended status must be selected
    qap_wombat_update_disable_msg=?Se debe seleccionar un estado extendido
    # 👽 qap_generic_error -> Error occured in WombatDialer
    qap_generic_error=?Se produjo un error en WombatDialer
    # 👽 qap_agent_not_available -> Agent not available
    qap_agent_not_available=?Agente no disponible
    # 👽 qap_dial_success -> Dialed
    qap_dial_success=?Marcado
    # 👽 qap_skip_success -> Skipped
    qap_skip_success=?Omitido
    # 👽 qap_no_call_to_reserve -> No call available for reservation
    qap_no_call_to_reserve=?No hay ninguna llamada disponible para reservar
    # 👽 qap_agent -> Agent
    qap_agent=?Agente
    ...
    qap_id_found_wrong_state=?El ID existe pero la llamada está en un estado incorrecto
    # 👽 ephatt_attribute_character_error -> Attribute name cannot contain the '.' character
    ephatt_attribute_character_error=?El nombre del atributo no puede contener el carácter '.'
    # 👽 rt3_att_text -> Ephemeral - Text
    rt3_att_text=?Efímero - Texto
    # 👽 rt3_nofstate_unix_wbt -> Ephemeral - Time
    rt3_nofstate_unix_wbt=?Efímero - Hora
    # 👽 rt3_circle_wbt_reservable -> Reservable calls
    rt3_circle_wbt_reservable=?Llamadas reservables
    # 👽 rt3_circle_wbt_incomplete -> Incomplete calls
    rt3_circle_wbt_incomplete=?Llamadas incompletas
    # 👽 rt3_nofstate_wbt -> Ephemeral - Value
    rt3_nofstate_wbt=?Efímero - Valor
    # 👽 rt3_wbt_campaign_stats -> Campaign stats
    rt3_wbt_campaign_stats=?Estadísticas de campaña
    # 👽 rt3_wbt_camp_est -> Attempts remaining
    rt3_wbt_camp_est=?Intentos restantes
    # 👽 rt3_attributes -> Ephemeral Attribute
    rt3_attributes=?Atributo efímero
    # 👽 rt3_display_value -> Visualization mode
    rt3_display_value=?Modo de visualización
    # 👽 rt3_maxvalue -> Max value
    rt3_maxvalue=?Valor máx.
    # 👽 rt3_md_checkbox -> Is markdown
    rt3_md_checkbox=?Es markdown
    # 👽 rt3_normal_number -> Normal
    rt3_normal_number=?Normal
    # 👽 rt3_normal_perc -> Percentage
    rt3_normal_perc=?Porcentaje
    ...
    reports_datablock_info_error=?No se ha podido cargar la información del DataBlock
    ...
    reports_email_not_valid=?Introduzca direcciones de correo electrónico válidas
    ...
    reports_qa_tracked_by=?Evaluado por
    ...
    reports_qa_nonscoring=?Evaluación sin puntuación
    ...
    sync2_delete_cluster=?Eliminar clúster
    ...
    timeline_chat_delete_confirm=?Se eliminará el Chat seleccionado. ¿Continuar?
    ...
    timeline_chat_segments_history=?Ver Historial de Ediciones
    # 👽 timeline_chat_segments_delete -> Delete Chat
    timeline_chat_segments_delete=?Eliminar Chat
    ...
    timeline_download_chat_file=?Descargar archivo
    ...
    timeline_no_chats=?No hay chats disponibles
    ...
    timeline_tab_chats_speaker_error=?Los nombres de los interlocutores deben ser únicos
    ...
    title_do_agentsdo=?Sesiones de Agentes y Pausas
    ...
    title_do_outcomesdo=?Llamada con Resultados
